...
See [manual](https://github.com/knrumsey/quack/blob/master/quack_0.0.0.9000.pdf) for details. 
  ...
  - [**Conformal Random Forests**](https://link.springer.com/article/10.1007/s10994-014-5453-0): An implementation of RF using the randomForest package. Out of bag trees are used for conformal inference, so no validation set is required. KNN is used for normalization. 
